...
function setup() {
    ...
    nodes[0].Height = 40;
    nodes[0].Width = 40;
    nodes[0].ownConnector(connectors.push(new Connector("output", "Start")) - 1);
    
    // End node
    nodes.push(new Node((width / 3 * 2) - 110, height / 2 - 20, "End"));
    nodes[1].Height = 40;
    nodes[1].Width = 40;
    nodes[1].ownConnector(connectors.push(new Connector("input", "End")) - 1);
}
